...
const Login = () => {
    ...
    return (
        <div className='  text-white text-white flex flex-col'>
            <h1 className='  text-white text-3xl font-bold text-center mt-20'>

                Login to Get your fans to support you
            </h1>
            <div className="  text-white social-login-buttons flex flex-col mt-0 text-white">


                <div className="  text-white flex flex-col gap-2 min-h-screen text-white p-10 items-center mt-0">


                    <button 
                        className=" w-80 text-white flex items-center mt-0 border  rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2  focus:ring-gray-500">
                        <svg className="  text-white h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                    ...
                    <button
                        className=" w-80 text-white flex items-center border  rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2  focus:ring-gray-500">
                        <svg className="  text-white h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
